...
public class CreationFournisseurPage {
	...
	@FindBy(xpath = "//*[@id=\"btModificationGen\"]/tbody/tr[2]/td[2]/em/button")
	...
	public void clickOnBtnDuplicationForm() {
	    ...
	    wait.until(ExpectedConditions.elementToBeClickable(btnDuplicationForm)).click();
	}

	// Bouton Interroger le formulaire
	public void clickOnBtnInterrogationForm() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	    wait.until(ExpectedConditions.elementToBeClickable(btnInterrogationForm)).click();
	}

	// Bouton Supprimer le formulaire
	public void clickOnBtnSuppressionForm() {
		WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
	    wait.until(ExpectedConditions.elementToBeClickable(btnSuppressionForm)).click();
	}
