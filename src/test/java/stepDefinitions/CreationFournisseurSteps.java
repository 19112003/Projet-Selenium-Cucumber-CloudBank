...
public class CreationFournisseurSteps {
	...
	public void user_fill_the_form() throws InterruptedException {
		...
		elements.enterFiltre("401000031");
		Thread.sleep(5000);
		...
		elements.enterFirstname("DYLANE");
		elements.enterLastname("AGOKA");
	...
	public void user_returns_to_the_empty_form() throws InterruptedException {
